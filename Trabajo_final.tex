...
La transfección puede ser útil para el estudio del funcionamiento de genes. Esto se puede realizar por dos medios: mediante un knockout o knockdown que anule la expresión de un gen, o insertando un gen extraño para evaluar su funcionamiento \cite{cryanin2004} .
